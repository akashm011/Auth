  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #333;">Welcome! You're Invited</h2>
        <p>You have been invited to join our exclusive platform.</p>
...
export async function sendCredentialsEmail(email, username, password) {
  const mailOptions = {
    from: process.env.EMAIL_FROM,
    to: email,
